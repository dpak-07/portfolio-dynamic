...
const blogPostsData = [
  {
    title: "From Curiosity to Code: The Path Behind My Portfolio",
    slug: "from-curiosity-to-code-the-path-behind-my-portfolio",
    author: "Deepak S",
    date: "2026-05-02",
    readTime: "7 min",
    tags: ["Journey", "Portfolio", "Learning"],
    cover: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=1600&h=900&fit=crop",
    excerpt: "A personal note on how curiosity, repeated practice, and real projects shaped the portfolio you see today.",
    content: `<h2>Where the journey started</h2><p>My path into development began with curiosity: how a simple idea becomes a working product, how interfaces guide people, and how systems stay reliable when real users touch them.</p><p>This portfolio is not only a showcase of projects. It is a record of the decisions, experiments, fixes, and lessons that helped me grow from learning the basics to building complete web experiences.</p><h3>What changed along the way</h3><ul><li>I learned to value clarity before complexity.</li><li>I started building projects that solve real problems instead of only practicing syntax.</li><li>I became more intentional about design, performance, accessibility, and deployment.</li></ul><h3>The path forward</h3><p>The next stage is about deeper engineering discipline: stronger architecture, better product thinking, AI-assisted workflows, cloud systems, and writing more openly about what each build teaches me.</p>`,
    published: true,
  },
  {
    title: "What Building Projects Taught Me About Professional Work",
    slug: "what-building-projects-taught-me-about-professional-work",
    author: "Deepak S",
    date: "2026-04-20",
    readTime: "6 min",
    tags: ["Projects", "Engineering", "Growth"],
    cover: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1600&h=900&fit=crop",
    excerpt: "The biggest lessons I learned while turning project ideas into stable, presentable, and useful products.",
    content: `<h2>Projects reveal the real work</h2><p>A project looks simple when it is finished, but the real learning happens in the middle: debugging broken flows, improving copy, handling empty states, cleaning data, and making the interface feel natural.</p><h3>Lessons that stayed with me</h3><ul><li>Good UI is not decoration. It is how users understand the product.</li><li>Reliable data handling matters as much as the visual design.</li><li>Small technical decisions become big user experiences.</li></ul><p>Every project made me more patient and more practical. I learned to ship, review, improve, and keep the work aligned with the people who will use it.</p>`,
    published: true,
  },
  {
    title: "Why I Started Writing My Build Journey",
    slug: "why-i-started-writing-my-build-journey",
    author: "Deepak S",
    date: "2026-04-05",
    readTime: "5 min",
    tags: ["Writing", "Reflection", "Career"],
    cover: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1600&h=900&fit=crop",
    excerpt: "A blog gives each project context: what I tried, what failed, what improved, and what comes next.",
    content: `<h2>Writing makes the path visible</h2><p>Code shows the result, but writing shows the thinking. I wanted a separate blog page because every build has a story: the first idea, the wrong turns, the breakthrough, and the final polish.</p><p>Documenting that journey helps me remember what I learned and helps visitors understand the kind of developer I am becoming.</p><h3>What I plan to share</h3><ul><li>Project breakdowns and design decisions.</li><li>Lessons from AI, cloud, frontend, and full-stack work.</li><li>Honest notes about mistakes, fixes, and growth.</li></ul><p>This blog will become the place where my portfolio gets a voice.</p>`,
    published: true,
  },
];
