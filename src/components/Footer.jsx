...
export default function Footer() {
  ...
  return (
    <motion.footer
      className="relative bg-gradient-to-b from-black/30 via-black/60 to-black/90 backdrop-blur-2xl border-t border-white/10 text-white py-16 mt-24 overflow-hidden"
      initial="hidden"
      whileInView="show"
      viewport={{ once: true }}
    >
      ...
      >
        ...
        <motion.span
          onClick={() => navigate("/admindsh")} // ✅ Redirect to Admin Dashboard
          whileHover={{
            scale: 1.3,
            rotate: [0, -10, 10, 0],
          }}
